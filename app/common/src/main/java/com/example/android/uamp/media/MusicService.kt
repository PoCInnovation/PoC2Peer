...
import com.example.android.uamp.media.datasource.CustomDataSourceFactory
...
open class MusicService : MediaBrowserServiceCompat() {
    ...
    private val dataSourceFactory: CustomDataSourceFactory by lazy {
    ...
    private val remoteJsonSource: Uri =
        Uri.parse("http://tracker.oursin.eu:3000/getSong") // TODO change this and we're pretty much done
