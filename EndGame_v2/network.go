...
import (
	...
	crypto "github.com/libp2p/go-libp2p-bittorent/crypto"
	host "github.com/libp2p/go-libp2p-bittorent/host"
	p2ppeer "github.com/libp2p/go-libp2p-bittorent/peer"
...
func (n *libp2pNetwork) Connect(id PeerID) error {
	stream, err := n.h.NewStream(context.Background(), id.(p2ppeer.ID), proto)
	if err != nil {
		return err
	}
